 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Beautiful sunrise view</p>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/virat.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/samantha.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/ajith.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/vijay.jpg" alt=" " class="img-responsive" />
					</li>
					</ul>
					<div class="resp-tabs-container">
					<div class="tab1">
						<div class="col-md-6 team-img-w2-agile">
						</div>
						<div class="col-md-6 team-Info-agileits">
							<h4>Viratkohli</h4>
							<span>Manager</span>
							<p>workhar stop not till the goal is reached</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>most beautiful place 
									enjoyed a lot 
									happy to visit again. </p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
